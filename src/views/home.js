...
const homeTemplate = (movies,userCheck) => html`
...
<section id="movie">
    <div class=" mt-3 ">
        <div class="row d-flex d-wrap">
            ...
            ${movies.length != 0 ? movies.map(movieTemplate) : html`<span class="text-center" style="display: block">There is no movies at the moment.</span>`}
...
export async function homePage(ctx) {
    const userCheck = sessionStorage.getItem('email');
    const movies = await getAllMovies();
    ctx.render(homeTemplate(movies,userCheck));
}